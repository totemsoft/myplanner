...
public class SplashWindow extends JDialog implements Runnable {
    ...
    public SplashWindow(String source) {
    ...
    public SplashWindow(String source, java.awt.Frame parent) {
        this(source, parent, 0);
    }

    public SplashWindow(String source, java.awt.Frame parent, long waitTime) {
            ...
            public void run() {
                if (SplashWindow.this.waitTime > 0) {
                    new Thread("SplashWindow::waitRunner") {
                        public void run() {
                            try {
                                sleep(SplashWindow.this.waitTime);
                            } catch (Exception e) {
                            }
                            close();
    ...
    static void main(String args[]) {
        final SplashWindow sw = new SplashWindow(null

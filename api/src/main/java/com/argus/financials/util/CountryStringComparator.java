package com.argus.financials.util;
...
public class CountryStringComparator implements Comparator<String> {

    private final String defaultCountry;

    public CountryStringComparator(String defaultCountry)
    {

...
package au.com.totemsoft.myplanner.exchange;
...
public class ExportData {
    ...
    public java.util.Collection transformXML2SQL(String xsl)
        ...
        if (xsl == null) {
            ...
            try {
                sql = au.com.totemsoft.myplanner.exchange.XMLTransformService
            ...
            sql = au.com.totemsoft.myplanner.exchange.XMLTransformService.transform(

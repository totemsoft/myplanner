...
import au.com.totemsoft.myplanner.chart.GraphData;
...
public abstract class MoneyCalc extends AbstractCalc
    ...
    protected int mod(int num1, int num2) {
        return au.com.totemsoft.math.Math.mod(num1, num2);
    }
    ...
    public static MoneyCalc getNewCalculator(int typeID) {
        ...
        case ModelType.iLOAN_MORTGAGE_CALC:
            ...
            try {
                Class clazz = Class.forName("au.com.totemsoft.myplanner.ui.projection.MortgageCalc");
    ...
    public Financial[] getGeneratedFinancials(String desc) {
        ...
        return c == null ? null : (au.com.totemsoft.myplanner.bean.Financial[]) c

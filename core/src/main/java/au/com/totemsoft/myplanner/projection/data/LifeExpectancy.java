...
import au.com.totemsoft.myplanner.api.CommonConstants;
    ...
    extends ServiceAware
{
    ...
    private static void load() {
        ...
        try {
            Integer countryCodeID = new au.com.totemsoft.myplanner.code.CountryCode()
                    .getCodeID(au.com.totemsoft.myplanner.config.FPSLocale

...
import au.com.totemsoft.myplanner.code.ContactMediaCode;
import au.com.totemsoft.myplanner.code.HealthStateCode;
import au.com.totemsoft.myplanner.code.IReportFields;
import au.com.totemsoft.myplanner.code.ResidenceStatusCode;
...
import au.com.totemsoft.myplanner.etc.DependentTableModel;
...
public final class ReportFields implements IReportFields {
    ...
    private static au.com.totemsoft.format.Currency currency;

    private static au.com.totemsoft.format.Percent percent;

    private static au.com.totemsoft.format.Number2 number;
    ...
    public synchronized void initialize() throws Exception {
        ...
        //new StrategyCalc()
        ((Reportable) Class.forName("au.com.totemsoft.myplanner.ui.projection.StrategyCalc").newInstance())
        ...
        new au.com.totemsoft.myplanner.report.data.InvRiskData().initializeReportData(this, null);

        /*
         * // 8. DSSData (social security) new
         * au.com.totemsoft.activex.data.DSSData().initializeReportData( this, null );
         */
        ...
        // 9. Gearing data
        //new MortgageCalc()
        ((Reportable) Class.forName("au.com.totemsoft.myplanner.ui.projection.MortgageCalc").newInstance())
        .initializeReportData(this, null);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                synchronized (lockObject) {
                    new Thread(splash, "SplashWindow2").start();

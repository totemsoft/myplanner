...
public class StrategyData {
     ...
     *  }
     * 
     * public void init( au.com.totemsoft.server.Person person,
     * au.com.totemsoft.strategy.StrategyGroup sg ) throws java.io.IOException//,
     * au.com.totemsoft.myplanner.service.ServiceException { // initPersonal( person );
     * 
     * 
     ...
     * ZERO;
     * 
     * while (it.hasNext()) { au.com.totemsoft.strategy.Recommendation reco =
     * (au.com.totemsoft.strategy.Recommendation)it.next(); java.util.Iterator it1 =

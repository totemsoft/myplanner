 ...
 */
public class AssetAllocationTableModel extends DefaultTableModel implements
        FinancialTypeID {
    ...
    public void updateModel(com.argus.financials.service.PersonService person)
         ...
         **********************************************************************/
        updateModel(person.getFinancials());
    }
                ...
                while (iter.hasNext()) {
                    try {
                        ...
                        if (f instanceof AssetCash) {
                            ...
                            if (f.getFinancialTypeID() != null
                                    && f.getFinancialTypeID().intValue() == TERM_DEPOSIT) {
                        ...
                        aatr.client_id = f.getOwnerPrimaryKeyID();
                        aatr.financial_id = f.getPrimaryKeyID();
                ...
                while (iter.hasNext()) {
                    try {
                        ...
                        if (f.getAssetAllocationID() == null) {
                            ...
                            AssetAllocationTableRow faa_aatr = faa
                                    .findByFinancialCode(f.getFinancialCode());
                            // and populate it
                            // aa.setAmount ( ( f.getAmount() == null ) ? new
                            // FormatedBigDecimal( 0.0 ) : new
                            // FormatedBigDecimal( f.getAmount().doubleValue() )
                        ...
                        aatr.client_id = new Integer(f.getOwnerPrimaryKeyID()
                                .intValue());
                        aatr.financial_id = new Integer(f.getPrimaryKeyID()
                                .intValue());
                        aatr.asset_allocation_id = aa.getAssetAllocationID(); // (f.getAssetAllocationID()
                                                                                // ==
                                                                                // null)
    ...
    public void saveModel(com.argus.financials.service.PersonService person)
        ...
        saveModel(person.getFinancials());
        ...
        if (assetCash != null) {
            ...
            while (iter.hasNext()) {
                ...
                if (f != null) {
                    ...
                    // updating... " + f.toString() + "<" + f.getPrimaryKeyID()
                    // + ">" );
                    ...
                    for (int i = 0; i < this._data.size() - 1; i++) { // -1,
                        ...
                        if (f.getPrimaryKeyID().equals(aatr.financial_id)) {
                            // System.err.println( this.getClass().getName() + "
                            ...
                            // );
                            // com.fiducian.license.FiducianHelper.printFieldNames(
                            // aa );
                            f.setModified(true);
                            // System.err.println( "after aa.getInCash()=" +
                            // aa.getInCash() + ", " + aa.getAssetAllocationID()
                            // );
                        }
                    }

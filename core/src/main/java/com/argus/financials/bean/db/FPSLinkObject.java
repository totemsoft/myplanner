...
public class FPSLinkObject extends AbstractPersistable {

    public static final int LINK_NOT_FOUND = -1;

    private static FPSLinkObject linkObject;

    public static synchronized FPSLinkObject getInstance() {
        if (linkObject == null)
            linkObject = new FPSLinkObject();
        return linkObject;
    }

    public synchronized int getLinkID(int objectID1, int objectID2,
    ...
    public synchronized int getLinkID(Integer objectID1, Integer objectID2,
            int linkObjectTypeID, Connection con) throws SQLException {
    ...
    public synchronized int link(int objectID1, int objectID2,
            int linkObjectTypeID, Connection con) throws SQLException {
    ...
    public synchronized int link(Integer objectID1, Integer objectID2,
            int linkObjectTypeID, Connection con) throws SQLException {
    ...
    public synchronized int link(Integer objectID1, Integer objectID2,
        ...
        try {
            ...
            linkID = getNewObjectID(linkObjectTypeID, con);
    ...
    public synchronized int unlink(int objectID1, int objectID2,
            int linkObjectTypeID, Connection con) throws SQLException {
    ...
    public synchronized int unlink(Integer objectID1, Integer objectID2,
            int linkObjectTypeID, Connection con) throws SQLException {
        ...
        try {
            ...
            sql.setInt(1, linkID);
            // if ( DEBUG ) System.out.println( "================= linkID " +
            // linkID );
            sql.executeUpdate();
    ...
    // use LinkID
    public synchronized int updateLinkForObject2(Integer linkID,
    ...
    // use ObjectID1
    public synchronized int updateLinksForObject2(Integer objectID1,
     ...
     * 
     */
    public synchronized List getLinkedObjects(int ownerPrimaryKeyID,
            int linkObjectTypeID, Connection con) throws java.sql.SQLException {
    ...
    public synchronized List getLinkedObjects(int ownerPrimaryKeyID,
            ...
            boolean toObjectID1, Connection con) throws java.sql.SQLException {
    ...
    public synchronized java.util.ArrayList getLinkedObjects(
    ...
    public synchronized java.util.ArrayList getLinkedObjects(
            ...
            int objectID2, int linkObjectTypeID2, boolean toObjectID1, // second
                                                                        // level
                                                                        // linkage
            Connection con) throws java.sql.SQLException {

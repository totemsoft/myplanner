...
public interface IReportFields {
    ...
    // PERSONAL //
    // //////////////////////////////////////////////////////////////////////////
    public static final String Client_Sex = "Client/Sex";
    public static final String Client_Title = "Client/Title";
    public static final String Client_IsMarried = "Client/IsMarried";
    public static final String Client_MaritalCode = "Client/MaritalCode";
    public static final String Client_FamilyName = "Client/FamilyName";
    public static final String Client_FirstName = "Client/FirstName";
    public static final String Client_OtherGivenNames = "Client/OtherGivenNames";
    public static final String Client_FullName = "Client/FullName";
    public static final String Client_DOB = "Client/DOB";
    public static final String Client_Age = "Client/Age";
    public static final String Client_LifeExpectancy = "Client/LifeExpectancy";
    public static final String Client_StateOfHealth = "Client/StateOfHealth";
    public static final String Client_Resident = "Client/Resident";
    public static final String Client_AgePensionQualifyingYear = "Client/AgePensionQualifyingYear";
    public static final String Client_AgePensionQualifyingAge = "Client/AgePensionQualifyingAge";
    public static final String Client_Dependents = "Client/Dependents";
    public static final String Client_PhoneWork = "Client/PhoneWork";
    public static final String Client_PhoneHome = "Client/PhoneHome";
    public static final String Client_Mobile = "Client/Mobile";
    public static final String Client_Fax = "Client/Fax";
    public static final String Client_Email = "Client/Email";
    public static final String Client_PostalAddress = "Client/PostalAddress";
    public static final String Client_PostalAddress_StreetNumber = "Client/PostalAddress/StreetNumber";
    public static final String Client_PostalAddress_StreetNumber2 = "Client/PostalAddress/StreetNumber2";
    public static final String Client_PostalAddress_Suburb = "Client/PostalAddress/Suburb";
    public static final String Client_PostalAddress_Postcode = "Client/PostalAddress/Postcode";
    public static final String Client_PostalAddress_State = "Client/PostalAddress/State";
    public static final String Client_PostalAddress_Country = "Client/PostalAddress/Country";
    public static final String Client_ResidentialAddress = "Client/ResidentialAddress";
    public static final String Client_ResidentialAddress_StreetNumber = "Client/ResidentialAddress/StreetNumber";
    public static final String Client_ResidentialAddress_StreetNumber2 = "Client/ResidentialAddress/StreetNumber2";
    public static final String Client_ResidentialAddress_Suburb = "Client/ResidentialAddress/Suburb";
    public static final String Client_ResidentialAddress_Postcode = "Client/ResidentialAddress/Postcode";
    public static final String Client_ResidentialAddress_State = "Client/ResidentialAddress/State";
    public static final String Client_ResidentialAddress_Country = "Client/ResidentialAddress/Country";
    public static final String Client_TargetAge = "Client/TargetAge";
    public static final String Client_TargetDate = "Client/TargetDate";
    public static final String Client_YearsToTargetAge = "Client/YearsToTargetAge";
    public static final String Client_TargetIncome = "Client/TargetIncome";
    public static final String Client_LumpSumRequired = "Client/LumpSumRequired";
    public static final String Client_Notes = "Client/Notes";
    public static final String Client_Employer_LegalName = "Client/Employer/LegalName";
    public static final String Client_Employer_TradingName = "Client/Employer/TradingName";
    public static final String Client_Occupation_EmploymentStatus = "Client/Occupation/EmploymentStatus";
    public static final String Client_Occupation_OccupationName = "Client/Occupation/OccupationName";
    public static final String Client_HealthCover = "Client/HealthCover";
    public static final String Client_NumberOfDependents = "Client/NumberOfDependents";
    public static final String Client_NameAgeOfDependents = "Client/NameAgeOfDependents";
    public static final String Client_FeeDate = "Client/FeeDate";
    public static final String Client_ReviewDate = "Client/ReviewDate";
    public static final String Client_DependentsNameAgeSentence = "Client/DependentsNameAgeSentence";
    public static final String Client_EmploymentStatus = "Client/EmploymentStatus";
    // Partner
    ...
    // Client
    public static final String CurrenPosition_ClientSex = "CP/Client/Sex";
    public static final String CurrenPosition_ClientDOB = "CP/Client/DOB";
    public static final String CurrenPosition_ClientAge = "CP/Client/Age";
    public static final String CurrenPosition_ClientTargetAge = "CP/Client/TargetAge";
    public static final String CurrenPosition_ClientTargetDate = "CP/Client/TargetDate";
    public static final String CurrenPosition_ClientTaxRate = "CP/Client/TaxRate";
    // Partner

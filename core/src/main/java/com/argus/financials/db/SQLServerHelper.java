...
public class SQLServerHelper extends BaseSQLHelper {

    private static SQLServerHelper sqlHelper;

    /** Creates new SQLServerHelper */
    protected SQLServerHelper() {
    }

    public static BaseSQLHelper getInstance() {
        if (sqlHelper == null)

...
public class DSSData extends com.argus.financials.bean.AbstractBase implements
    ...
    protected static final com.argus.math.Percent _percent;
    static {
        _percent = new com.argus.math.Percent();
    ...
    public void init(com.argus.financials.service.PersonService person,
         ...
         * dssCalc2.getMaritalStatus().equals(com.argus.code.MaritalCode.SINGLE) ?

 ...
 * Modified: 30/40/2003
 * By:       shibaevv
 * Comment:  Changed class to support com.argus.activex.Reportable interface
 * ============================================================================
 */
...
public class InvRiskData // extends BaseData
    ...
    protected com.argus.math.Percent percent = new com.argus.math.Percent();
     ...
     */
    private String checkQuestion(com.argus.financials.etc.Survey.Question q) {
     ...
     */
    private String getAllAnswers(com.argus.financials.etc.Survey.Question q) {
        ...
        if (q != null && q.getSelectedAnswers() != null) {
            ...
            for (int i = 0; i < obj.length; i++) {
                ...
                com.argus.financials.etc.Survey.Question.Answer a = (com.argus.financials.etc.Survey.Question.Answer) obj[i];
    ...
    public class QuestionAnswerTableModel extends
            com.argus.financials.swing.table.SmartTableModel {
        protected Integer surveyID = null;

        protected Integer investmentStrategyCodeID = null;

        protected com.argus.financials.etc.Survey survey = null;
        ...
        public QuestionAnswerTableModel(com.argus.financials.etc.Survey survey)
                throws java.io.IOException {
            if (survey != null) {
                this.survey = survey;
        ...
        private void questionAnswersInit() throws java.io.IOException {
            ...
            if (survey != null) {
                ...
                com.argus.financials.etc.Survey.Question q;
                while ((q = survey.getQuestionByNumber(n++)) != null) {
                    ...
                    // because it's based completly on HTML and it's to long
                    if (n == 19) {
        ...
        protected com.argus.financials.etc.Survey getSurvey() {
            return survey;
        }

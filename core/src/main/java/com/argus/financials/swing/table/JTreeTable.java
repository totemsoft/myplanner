...
public class JTreeTable extends JTable {
    ...
    protected boolean isLeaf() {
        if (tree == null)
            return false;
        return tree.getModel().isLeaf(tree.visibleNode);
    }
    ...
    public java.awt.Font getFont() {
        ...
        if (leafFont == null)
            leafFont = font; // default

        if (this.isLeaf())
            return leafFont;

        if (nonLeafFont == null)
            nonLeafFont = new java.awt.Font(font.getName(), java.awt.Font.BOLD,
                    font.getSize());
        return nonLeafFont;
     ...
     * 
     * public java.awt.Color getBackground() { if ( defaultColor == null )
     * defaultColor = super.getBackground(); if ( isLeaf() ) return
     * defaultColor; return java.awt.Color.lightGray; }
     */

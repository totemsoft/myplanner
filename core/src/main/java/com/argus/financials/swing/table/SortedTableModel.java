...

{
    ...
    public int compareRowsByColumn(int row1, int row2, int column) {
        ...
        if (type.getSuperclass() == java.lang.Number.class) {
        ...
        } else if (type == com.argus.format.Number2.class) {
            com.argus.format.Number2 number2 = com.argus.format.Number2
                    .getNumberInstance();

            Double d1 = number2.getDoubleValue((String) o1);
            Double d2 = number2.getDoubleValue((String) o2);
            return compare(d1, d2);
        } else if (type == com.argus.format.Currency.class) {
            ...
            return compare(d1, d2);
        } else if (type == com.argus.format.Percent.class) {
            com.argus.format.Percent percent = com.argus.format.Percent
                    .getPercentInstance();

...
import com.argus.math.AverageFunction;
import com.argus.math.SumFunction;
...
public class FinancialTableModel2 extends javax.swing.table.AbstractTableModel
    ...
    protected static final com.argus.format.Number2 number4;

    protected static final com.argus.math.Money money;

    protected static final com.argus.math.Percent percent;
    static {
        number4 = com.argus.format.Number2.createInstance();
    ...
    public Financial[] getFinancials(FinancialTreeFilter filter) {
        ...
        return (com.argus.financials.bean.Financial[]) _data
    ...
    protected java.lang.Number[] getNumericData(int columnIndex,
        ...
        for (int i = 0; i < getRowCount(); i++) {
            ...
            if (row instanceof FinancialRow
                ...
                } else if (value instanceof com.argus.math.Numeric) {
                    _data.add(new Double(((com.argus.math.Numeric) value)
                            .doubleValue()));
                    continue;

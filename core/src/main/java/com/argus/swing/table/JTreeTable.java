 ...
 * <p>Title: </p>
 * <p>Description: 
 * This example shows how to create a simple JTreeTable component, by using a JTree
...
public class JTreeTable extends JTable {
	...
	public class TreeTableCellRenderer extends JTree implements TableCellRenderer {
		...
		private Object visibleNode;

		private java.awt.Font nonLeafFont = null;
		private java.awt.Font leafFont = null;


		public TreeTableCellRenderer() {
			super();
		}
		//private TreeTableCellRenderer(TreeTableModel treeTableModel) {
		//	super(treeTableModel);
		//}

		
	    //public TreeTableModel getTreeTableModel() {
	    //	return (TreeTableModel) getTreeTableModel();
	    //}
		...
		public java.awt.Font getFont() {
			java.awt.Font font = super.getFont();
			if (font == null)
				return null;

			if (leafFont == null)
				leafFont = new java.awt.Font(font.getName(), java.awt.Font.PLAIN, font.getSize());
			if (nonLeafFont == null)
				nonLeafFont = new java.awt.Font(font.getName(), java.awt.Font.BOLD, font.getSize());

			return isLeaf() ? leafFont : nonLeafFont;

		}

		private boolean isLeaf() {
			if (visibleNode instanceof ITreeTableNode)
				return ((ITreeTableNode) visibleNode).isLeaf();
			return false;
		}
	 ...
	 */
    public void setColumnWidth( int columnID, int maxWidth, int minWidth, int preferredWidth ) {

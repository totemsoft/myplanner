...
ON 
	...
	FILENAME = N'D:\database\mssql\MyPlanner_Data.MDF' , 
	SIZE = 5, 
	FILEGROWTH = 10%
	--), (
	--NAME = N'MyPlanner_Data2', 
	--FILENAME = N'C:\database\mssql\MyPlanner_Data2_Data.NDF' , 
	--SIZE = 5, 
	--FILEGROWTH = 10%
	) 
LOG ON 
	...
	FILENAME = N'D:\database\mssql\MyPlanner_Log.LDF' , 
	SIZE = 5, 
	FILEGROWTH = 10%
	--), (
	--NAME = N'MyPlanner_Log2', 
	--FILENAME = N'C:\database\mssql\MyPlanner_Log2_Log.LDF' , 
	--SIZE = 5, 
	--FILEGROWTH = 10%
	)

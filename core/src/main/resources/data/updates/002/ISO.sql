...
VALUES (1, 'What is your opinion for the Australian economy over the next 3 to 5 years? ', @SurveyID)
SELECT @@IDENTITY
...
-- question 2
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'How concerned are you that the returns on your investment do not exceed the rate of inflation?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 3
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'What in your opinion will be the average inflation rate in Australia for the next 3 years?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 4
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'Please indicate the level of return you would target?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 5
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'Keeping in mind this fact: "the higher the return, the higher the risk", approximately what annual rate of return would you expect to meet your goals?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 6
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'How would you react if your long-term investments declined by 10% in one year?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 7
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'Share investments are subject to price volatility. What would you do with a share that declined by more than 20% in a year? (Assuming your overall portfolio fundamentals are the same)', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 8
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'What would you do with a share that increased by more than 20% in a year? (Assuming your overall portfolio fundamentals are the same)', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 10
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'For the assets you are investing, please identify which of the following investment objectives is most important to you?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 12
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'If you held assets managed by professional fund managers, what reasons do you think could cause you to wish to change investment managers?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 13
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'Do you believe that professionally trained fund managers have a better probability of delivering expected returns?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- question 14
INSERT Question (QuestionTypeID, QuestionDesc, SurveyID)
VALUES (1, 'What is the shortest length of time you are able to commit to holding your investments, without needing to sell them and withdraw capital?', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY
...
-- answer 18
INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
VALUES ('Conservative: I would select investments with a high level of secure income with a strong emphasis on security and preservation of capital.', 1, @QuestionID)
INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
VALUES ('Conservative / Balanced:  I would select investments with secure and stable income although there would also be an expectation of some capital growth over the medium to longer term.  I would be looking for some tax effectiveness of income, with some exposure to shares and property.', 2, @QuestionID)
INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
VALUES ('Balanced / Growth: I would select investments giving a combination of capital growth and income. I would be prepared for some fluctuations in capital value and understands that there can be a negative return on the portfolio.  I can tolerate some fluctuation of income returns. Generally, I would hold my investments for over five years.', 3, @QuestionID)
INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
VALUES ('Growth: I would expect to receive capital growth with some income over the longer term.  Short-term asset protection is relevant, but not a serious consideration.  I would select a relatively high weighting towards growth assets such as shares and property. I would select investments for the long-term and understand the volatility inherently accompanies investment in shares and property.  I would be prepared to accept fluctuations in capital value and the possibility of negative returns in the short-term.', 4, @QuestionID)
INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
VALUES ('Aggressive: I would be looking to maximise my returns over a long period of time, at least seven to ten years.  I would also be seeking very high exposure to growth assets, such as shares and property, and would be prepared to accept considerable fluctuations (negative and positive) in capital value over short intervals as a result of changes in market conditions.  Income is not a priority for this investor.  Exposure would be predominantly in growth assets that could comprise different classes of shares, property and specialist funds.', 5, @QuestionID)
...
<B><FONT FACE="Arial" SIZE=2><P>Question 19</P>
</B></FONT><FONT SIZE=2><P ALIGN="JUSTIFY"></P>
<P ALIGN="JUSTIFY">Below is a table outlining the performance of hypothetical investment portfolio strategies over a seven year time period. </P>
</FONT><P ALIGN="JUSTIFY"></P>
<B><FONT SIZE=2><P ALIGN="JUSTIFY">% Return per Investment Strategy</P>
</B></FONT><P ALIGN="JUSTIFY"></P>
<TABLE BORDER CELLSPACING=1 CELLPADDING=7 WIDTH=648>
<TR><TD WIDTH="21%" VALIGN="TOP" COLSPAN=2>&nbsp;</TD>
...
<TR><TD WIDTH="4%" VALIGN="TOP" HEIGHT=27>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">1</B></FONT></TD>
<TD WIDTH="18%" VALIGN="TOP" HEIGHT=27>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">Conservative</B></FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">4.5%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">5.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">5.5%</FONT></TD>
<TD WIDTH="10%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">5.0%</FONT></TD>
...
<FONT SIZE=3><P ALIGN="CENTER">5.5%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">5.3%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP" HEIGHT=27>
<FONT SIZE=3><P ALIGN="CENTER">5.0%</FONT></TD>
</TR>
...
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">-2.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">5.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">14.0%</FONT></TD>
<TD WIDTH="10%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">11.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">6.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">11.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">8.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">7.5%</FONT></TD>
</TR>
<TR><TD WIDTH="4%" VALIGN="TOP">
...
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">-4.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">8.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">15.0%</FONT></TD>
<TD WIDTH="10%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">19.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">1.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">16.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">13.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">9.4%</FONT></TD>
</TR>
<TR><TD WIDTH="4%" VALIGN="TOP" HEIGHT=26>
...
<FONT SIZE=3><P ALIGN="CENTER">-6.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">10.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">18.0%</FONT></TD>
<TD WIDTH="10%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">22.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">-1.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">18.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">16.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP" HEIGHT=26>
<FONT SIZE=3><P ALIGN="CENTER">10.5%</FONT></TD>
</TR>
<TR><TD WIDTH="4%" VALIGN="TOP">
...
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">-12.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">25.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">20.0%</FONT></TD>
<TD WIDTH="10%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">37.0%</FONT></TD>
<TD WIDTH="11%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">-8.0%</FONT></TD>
<TD WIDTH="9%" VALIGN="TOP">
<FONT SIZE=3><P ALIGN="CENTER">20.0%</FONT></TD>
...
<TR><TD WIDTH="4%" VALIGN="TOP" HEIGHT=29>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">1</B></FONT></TD>
<TD WIDTH="18%" VALIGN="TOP" HEIGHT=29>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">Conservative</B></FONT></TD>
...
<TR><TD WIDTH="4%" VALIGN="TOP" HEIGHT=34>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">3</B></FONT></TD>
<TD WIDTH="18%" VALIGN="TOP" HEIGHT=34>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">Balanced-Growth</B></FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=34>
...
<TD WIDTH="10%" VALIGN="TOP" HEIGHT=34>
...
<B><FONT SIZE=3><P ALIGN="JUSTIFY">4</B></FONT></TD>
<TD WIDTH="18%" VALIGN="TOP" HEIGHT=30>
<B><FONT SIZE=3><P ALIGN="JUSTIFY">Growth</B></FONT></TD>
<TD WIDTH="9%" VALIGN="TOP" HEIGHT=30>
...
<TD WIDTH="20%" VALIGN="TOP">
<FONT SIZE=2><P ALIGN="CENTER">1,24,7796</FONT></TD>
</TR>
</TABLE>

<FONT SIZE=2>
<P>Based on this information above, which investment strategy would you choose?</P></FONT></BODY>
</HTML>', @SurveyID)
SELECT @@IDENTITY
SET @QuestionID = @@IDENTITY

--------------------------------------------------------------
-- BUG FIX 479 - 18/07/2002
--
-- see also answer 1
--------------------------------------------------------------

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_temp]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
-- answer 4
 ...
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('Return above inflation by 4%', 3, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('Return above inflation by 6%', 4, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('Return above inflation by 8%', 5, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('Return above inflation by 8% Plus', 6, @QuestionID)
...
-- answer 10
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Preservation of Assets </B> - Growth to equal inflation. Minimum Investment time period of 3-5 years.', 1, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Income</B> - Generate Income while limiting risk of capital losses. Minimum Investment Period 3 to 5 years.', 2, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Capital Growth plus Income</B> - Accept that growth may differ to markets growth. Minimum investment time period 5 years.', 3, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Capital Growth</B> - Maximise long-term returns, while accepting the possibility of short term negative growth. Minimum investment time period over 5 years.', 4, @QuestionID)
...
-- answer 18
 ...
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Conservative:</B>  I would select investments with secure and stable income although there would also be an expectation of some capital growth over the medium to longer term.  I would be looking for some tax effectiveness of income, with some exposure to shares and property.', 2, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Conservative / Balanced:</B> I would want a combination of capital growth and income from investments. I am prepared for some fluctuations in capital value and understand that there can be a negative return on the portfolio if more than one asset class falls in value.  I can tolerate some fluctuation of income returns. Generally, I would hold my investments for over five years.', 3, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Balanced:</B> I would select investments giving a combination of capital growth and income with a higher focus on capital growth than for the Conservative Balanced category. I would be prepared for some fluctuations in capital value and understand that there can be a negative return on the portfolio.  I can tolerate some fluctuations of income returns. Generally, I would hold my investments for over five years.', 4, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Growth:</B> I would expect to receive capital growth with some income over the longer term.  Short-term asset protection is relevant, but not a serious consideration.  I would select a relatively high weighting towards growth assets such as shares and property. I would select investments for the long-term and understand the volatility inherently accompanies investment in shares and property.  I would be prepared to accept fluctuations in capital value and the possibility of negative returns in the short-term.', 5, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Strong Growth:</B> I would be looking to maximise my returns over a long period of time, at least seven to ten years.  I would also be seeking very high exposure to growth assets, such as shares and property, and would be prepared to accept considerable fluctuations (negative and positive) in capital value over short intervals as a result of changes in market conditions.  Income is not a priority for me.  Exposure would be predominantly in growth assets that could comprise different classes of shares, property and specialist funds. Such investors would understand that investing in growth assets, particularly if held for short periods, could involve considerable volatility in portfolio capital values.', 6, @QuestionID)
 INSERT QuestionAnswer (QuestionAnswerDesc, QuestionAnswerScore, QuestionID)
 VALUES ('<B>Ultra Growth:</B> I would also be looking to maximise returns over a long period of time, at least seven to ten years.  I would be seeking very high exposure to growth assets, such as shares and property, and would be prepared to accept considerable fluctuations (negative and positive) in capital value over short intervals as a result of changes in market conditions.  I would not be interested in income.  Exposure would be totally in growth assets that could comprise different classes of shares, property and specialist funds.  I would understand that investing in growth assets, particularly if held for short periods, could involve considerable volatility in portfolio capital.', 7, @QuestionID)

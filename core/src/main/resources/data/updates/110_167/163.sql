IF ( exists ( SELECT * FROM DBVersion WHERE CurrentVersion = 'FID.01.63' ) )
	RAISERROR( 'FID.01.63 already exists', 16, 1 ) 
...
-- EXEC [dbo].[sp_import_FinancialService] 'SS', 'Superannuation Services'

...
DELETE FROM FinancialMapSV2 WHERE FinancialTypeID IN (1001,1002,1003,1004,1011,1014,1015,1016,1017);
...
DELETE FROM FinancialMapSV2 WHERE FinancialTypeID IN (1005,1006,1007,1008,1009,1010,1012,1013);
...
DELETE FROM FinancialMapSV2 WHERE FinancialTypeID IN (2001,2002,2003,2004,2005);
...
ALTER TABLE FinancialMapSV2 DROP CONSTRAINT FK_FinancialMapSV2_FinancialCodeType;

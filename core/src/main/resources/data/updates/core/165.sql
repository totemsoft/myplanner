...
CREATE FUNCTION dbo.getUnitPrice (@code int)
 ...
 BEGIN 
	...
	SELECT TOP 1 @UnitPrice = exit_price 
	FROM unit_price_data
	WHERE code = @code
	AND price_date = (
...
GO
--SELECT getUnitPrice( 6790 )


if exists (select * from sysobjects where id = object_id(N'dbo.getUnitPriceDate') and xtype in (N'FN', N'IF', N'TF'))
...
CREATE FUNCTION dbo.getUnitPriceDate (@code int)
 ...
 BEGIN 
	...
	SELECT TOP 1 @UnitPriceDate = price_date 
	FROM unit_price_data
	WHERE code = @code
	AND price_date = (
		SELECT MAX( price_date )
...
GO
--SELECT getUnitPriceDate( 6790 )


if exists (select * from sysobjects where id = object_id(N'dbo.vAssetInformation') and OBJECTPROPERTY(id, N'IsView') = 1)
  drop view dbo.vAssetInformation
GO
CREATE VIEW vAssetInformation
  AS

  SELECT DISTINCT 
	apir_pic.apir_pic AS apir, 
	apir_pic.code AS code,
	product_information.full_name AS AssetName, 
	manager_data.full_name AS Institition, 
	dbo.getUnitPrice( apir_pic.code ) AS UnitPrice,
	dbo.getUnitPriceDate( apir_pic.code ) AS UnitPriceDate
  FROM	apir_pic, product_information, manager_data
  WHERE apir_pic.code = product_information.code
	AND product_information.manager_code = manager_data.code
...
-- 	JOURNAL TABLES
---------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'dbo.AssetAllocationJournal') and OBJECTPROPERTY(id, N'IsTable') = 1)
 drop table AssetAllocationJournal
GO
if exists (select * from sysobjects where id = object_id(N'dbo.FinancialJournal') and OBJECTPROPERTY(id, N'IsTable') = 1)
 drop table FinancialJournal
GO
if exists (select * from sysobjects where id = object_id(N'dbo.Journal') and OBJECTPROPERTY(id, N'IsTable') = 1)
 drop table Journal
GO
if exists (select * from sysobjects where id = object_id(N'dbo.JournalStatus') and OBJECTPROPERTY(id, N'IsTable') = 1)
...
-- 	Required sp(s)
---------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'dbo.sp_journal_create') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_select_Journal') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_update_FinancialCode') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
CREATE PROCEDURE dbo.sp_update_FinancialCode 
 ...
 AS
  ...
  SET @ASSET_SWAPPED = 1
	...
	-- find new FinancialCode ( apir_pic )
	...
	BEGIN
		RAISERROR( 'Failed to find new FinancialCode ( apir_pic )', 16, 1 ) 
		RETURN 0
	END
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_select_Financial') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'vAssetJournal') and OBJECTPROPERTY(id, N'IsView') = 1)
 drop view vAssetJournal
GO
CREATE VIEW vAssetJournal
 AS
 SELECT 
	  Object.ObjectTypeID
	, Asset.*
 ...
 FROM	Object, Asset, 
    FinancialJournal LEFT OUTER JOIN
    FinancialType ON (FinancialJournal.FinancialTypeID = FinancialType.FinancialTypeID) LEFT OUTER JOIN
    FinancialCode ON (FinancialJournal.FinancialCodeID = FinancialCode.FinancialCodeID) LEFT OUTER JOIN
    AssetAllocation ON (FinancialJournal.AssetAllocationID = AssetAllocation.AssetAllocationID)
 WHERE  Object.ObjectID = Asset.AssetID
	AND Asset.AssetID = FinancialJournal.FinancialID 
GO


if exists (select * from sysobjects where id = object_id(N'dbo.sp_select_FinancialJournal') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_restore_FinancialCode') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_delete_FinancialCode') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
if exists (select * from sysobjects where id = object_id(N'dbo.sp_delete_financials') and OBJECTPROPERTY(id, N'IsProcedure') = 1)

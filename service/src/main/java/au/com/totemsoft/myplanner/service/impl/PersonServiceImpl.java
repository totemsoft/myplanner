...
import au.com.totemsoft.myplanner.api.dto.PersonDto;
...
import au.com.totemsoft.myplanner.bean.db.FinancialGoalBean;
import au.com.totemsoft.myplanner.bean.db.ObjectClass;
import au.com.totemsoft.myplanner.code.AddressCode;
import au.com.totemsoft.myplanner.code.BooleanCode;
import au.com.totemsoft.myplanner.dao.BusinessDao;
import au.com.totemsoft.myplanner.domain.hibernate.Occupation;
import au.com.totemsoft.myplanner.domain.hibernate.refdata.Country;
import au.com.totemsoft.myplanner.domain.hibernate.refdata.Language;
...
import au.com.totemsoft.myplanner.etc.db.AddressBean;
import au.com.totemsoft.myplanner.etc.db.CommentBean;
import au.com.totemsoft.myplanner.etc.db.ContactBean;
import au.com.totemsoft.myplanner.etc.db.ContactMediaBean;
import au.com.totemsoft.myplanner.etc.db.DependentBean;
import au.com.totemsoft.myplanner.etc.db.PersonHealth;
import au.com.totemsoft.myplanner.etc.db.PersonTrustDIYStatus;
import au.com.totemsoft.myplanner.etc.db.SurveyBean;
...
public class PersonServiceImpl extends AbstractServiceImpl implements PersonService {
    ...
    private void storeModels(Connection con) throws SQLException {
        ...
        while (iterModels.hasNext()) {
            ...
            // au.com.totemsoft.util.Collection.removeNullValues( _models );
    ...
    public int storePlan(au.com.totemsoft.util.ReferenceCode plan, Integer planTypeID)
            throws ServiceException {
    ...
    private int storePlan(au.com.totemsoft.util.ReferenceCode plan,
    ...
    public boolean deletePlan(au.com.totemsoft.util.ReferenceCode plan,

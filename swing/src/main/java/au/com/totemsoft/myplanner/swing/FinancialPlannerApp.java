...
import au.com.totemsoft.swing.StatusBarPanel;
import au.com.totemsoft.swing.SwingUtil;
import au.com.totemsoft.swing.SwingUtils;
import au.com.totemsoft.swing.plaf.MetalTheme;
    ...
    implements FocusListener
{
    ...
    private SplashWindow splashWindow;// = new SplashWindow2("/image/logo/splash.gif", this, 10000);
    ...
    private void syncDBSchema() {
        try {
            ...
            if (JOptionPane.showConfirmDialog(SwingUtil.getSharedOwnerFrame(),
                ...
                try {
                    Process process = au.com.totemsoft.io.DOSRunner.getInstance().run(
                            cmd, "/c");

...
import au.com.totemsoft.myplanner.code.StatusCode;
...
public abstract class PersonView extends BaseView {
    ...
    private void initComponents2() {
        ...
        jComboBoxSmoker.setModel(new javax.swing.DefaultComboBoxModel(
                (au.com.totemsoft.util.ReferenceCode[]) new BooleanCode().getCodes()
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        jTextFieldDateOfBirth = new au.com.totemsoft.bean.FDateChooser();
        ...
        jTextFieldFeeDate = new au.com.totemsoft.bean.FDateChooser();
        jTextFieldReviewDate = new au.com.totemsoft.bean.FDateChooser();
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldFeeDate;
    ...
    protected au.com.totemsoft.bean.FDateChooser jTextFieldDateOfBirth;
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldReviewDate;

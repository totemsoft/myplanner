...
public class AssetAllocationPieChartView extends javax.swing.JPanel implements
        au.com.totemsoft.io.ImageEncoder {
    ...
    /*
     * same values like au.com.totemsoft.code.InvestmentStrategyData, plus an
    ...
    public void saveChart(java.io.File file) throws java.io.IOException {
        ...
        try {
            au.com.totemsoft.io.ImageUtils.encodeAsJPEG(this, file);
        } catch (Exception e) {

...
import au.com.totemsoft.myplanner.assetallocation.AssetAllocationAssetNameComperator;
...
public class AssetAllocationTableModel extends DefaultTableModel {
    ...
    Class[] types = new Class[] { java.lang.String.class, // "Asset Name"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Value ($)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Cash (%)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Fixed Interest (%)
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Aust. Shares (%)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Intnl. Shares (%)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Property (%)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Other (%)"
            au.com.totemsoft.math.FormatedBigDecimal.class, // "Total (%)"

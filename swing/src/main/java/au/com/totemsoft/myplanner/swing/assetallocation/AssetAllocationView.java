...
import au.com.totemsoft.format.DecimalField;
import au.com.totemsoft.myplanner.assetallocation.TotalColumnRender;
    ...
    extends AbstractPanel
{
    ...
    protected void initTable(JTable jtable) {
        ...
        jtable.setDefaultEditor(au.com.totemsoft.math.FormatedBigDecimal.class,
                dce_FormatedBigDecimal);
        // ((DefaultCellEditor)jtable.getDefaultEditor(au.com.totemsoft.financial.assetallocation.FormatedBigDecimal.class)).setClickCountToStart(1);
    }

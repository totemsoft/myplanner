...
public class CashFlowView extends au.com.totemsoft.myplanner.swing.GraphTableView
    ...
    protected String getDefaultReport() {
        return current ? au.com.totemsoft.myplanner.config.WordSettings.getInstance()
                .getCashFlowReport() : au.com.totemsoft.myplanner.config.WordSettings
    ...
    public au.com.totemsoft.io.ImageEncoder getCashFlowGraph() {
        return graphView;
    }

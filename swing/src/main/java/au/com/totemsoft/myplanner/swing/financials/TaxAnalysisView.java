...
import au.com.totemsoft.myplanner.table.swing.JSmartTable;

public class TaxAnalysisView extends au.com.totemsoft.myplanner.swing.BaseView implements
    ...
    public void updateView(PersonService person, java.util.Map financials,
            String prefix) throws au.com.totemsoft.myplanner.api.ServiceException {
    ...
    protected String getDefaultReport() {
        return current ? au.com.totemsoft.myplanner.config.WordSettings.getInstance()
                .getTaxAnalysisReport()
                : au.com.totemsoft.myplanner.config.WordSettings.getInstance()

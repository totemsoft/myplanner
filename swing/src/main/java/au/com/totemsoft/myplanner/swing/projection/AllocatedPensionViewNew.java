...
import au.com.totemsoft.myplanner.chart.APGraphViewNew;
import au.com.totemsoft.myplanner.chart.IGraphView;
import au.com.totemsoft.myplanner.code.APRelationshipCode;
import au.com.totemsoft.myplanner.code.APRelationshipCodeID;
import au.com.totemsoft.myplanner.code.DeathBenefitCode;
import au.com.totemsoft.myplanner.code.DeathBenefitCodeID;
import au.com.totemsoft.myplanner.code.GeneralTaxExemptionCode;
import au.com.totemsoft.myplanner.code.GeneralTaxExemptionCodeID;
...
import au.com.totemsoft.myplanner.code.SelectedAnnualPensionCode;
...
import au.com.totemsoft.myplanner.swing.ListenerUtils;
...
import au.com.totemsoft.swing.ProjectToAgeInputVerifier;
...
public class AllocatedPensionViewNew
    ...
    implements
        ...
        au.com.totemsoft.swing.ICloseDialog {
    ...
    private static au.com.totemsoft.math.Money money;
    static {
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        jTextFieldPensionStartDate = new au.com.totemsoft.bean.FDateChooser();
        jTextFieldFirstPaymentDate = new au.com.totemsoft.bean.FDateChooser();
        jTextFieldNamePartner = new javax.swing.JTextField();
        jTextFieldDOBPartner = new au.com.totemsoft.bean.FDateChooser();
        ...
        jTextFieldEligibleServiceDate = new au.com.totemsoft.bean.FDateChooser();
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldEligibleServiceDate;
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldDOBPartner;
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldFirstPaymentDate;
    ...
    private au.com.totemsoft.bean.FDateChooser jTextFieldPensionStartDate;

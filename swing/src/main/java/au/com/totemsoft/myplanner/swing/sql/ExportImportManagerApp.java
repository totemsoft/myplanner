    ...
    extends AbstractPanel
{
    ...
    private javax.swing.JFileChooser getFileChooser() {
        ...
        if (jFileChooser == null) {
            ...
            jFileChooser.setFileFilter(new au.com.totemsoft.io.XMLFileFilter());
    ...
    private void doExport() throws java.sql.SQLException, java.io.IOException {
        ...
        // au.com.totemsoft.server.RmiParams.getInstance().getUserPersonID();
        Integer clientPersonID =
        // new Integer(32811); // Jim Ediot
        new Integer(68767); // Export ClientView
        // au.com.totemsoft.server.RmiParams.getInstance().getClientPersonID();
    ...
    private void test(String s) {
        au.com.totemsoft.myplanner.strategy.StrategyGroup sg = new au.com.totemsoft.myplanner.strategy.StrategyGroup();

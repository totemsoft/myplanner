...
import au.com.totemsoft.myplanner.strategy.model.BaseDataModel;
...
import au.com.totemsoft.myplanner.swing.assetallocation.NewAssetAllocationView;
...
import au.com.totemsoft.myplanner.swing.projection.DSSView;
    ...
    implements FinancialClassID, au.com.totemsoft.swing.IReset
{
    ...
    public au.com.totemsoft.format.Currency getCurrency() {
    ...
    private void doCashFlow() {
         ...
         * au.com.totemsoft.myplanner.service.ServiceException e ) { e.printStackTrace( System.err );
         * return; }
         */

...
import au.com.totemsoft.util.Enumeration;
...
public class DocumentTreeTableModel extends AbstractTreeTableModel {
	...
	/* (non-Javadoc)
	 * @see au.com.totemsoft.table.TreeTableModel#getColumnCount()
	 */
	...
	/* (non-Javadoc)
	 * @see au.com.totemsoft.table.TreeTableModel#getColumnName(int)
	 */
	...
	/* (non-Javadoc)
	 * @see au.com.totemsoft.table.TreeTableModel#getColumnClass(int)
	 */
     ...
     * 
	 * (non-Javadoc)
	 * @see TreeTableModel#isCellEditable(ITreeTableNode, int)
     */
    ...
    /* (non-Javadoc)
	 * @see au.com.totemsoft.table.TreeTableModel#getValueAt(ITreeTableNode, int)
	 */
	...
	/* (non-Javadoc)
	 * @see au.com.totemsoft.table.TreeTableModel#setValueAt(Object, ITreeTableNode, int)
	 */

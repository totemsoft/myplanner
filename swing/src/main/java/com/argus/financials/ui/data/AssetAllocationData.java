...
import com.argus.math.Money;
import com.argus.math.Numeric;
import com.argus.math.Percent;
...
public class AssetAllocationData extends com.argus.financials.bean.AbstractBase
    ...
    public class AssetAllocationTableModel extends FinancialTableModel {
        ...
        private void initRecommendedData(PersonService person)
            ...
            RecommendedGraph = com.argus.io.ImageUtils.encodeAsJPEG(aapcv);
        ...
        private void initCurrentData(java.util.Map financials)
            ...
            CurrentGraph = com.argus.io.ImageUtils.encodeAsJPEG(aapcv);
        ...
        private void initNewData(java.util.Map newFinancials)
            ...
            ProposedGraph = com.argus.io.ImageUtils.encodeAsJPEG(aapcv);

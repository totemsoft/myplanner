        ...
        try {
            ...
            if (person != null) {
                ...
                if (fg != null) {
                    ...
                    snapshotCalc
                            .setYearsSpend(n == null ? 0. : n.doubleValue());

                    amount = fg.getResidualReq();
                    snapshotCalc.setResidualValue(amount == null ? 0. : amount
                            .doubleValue());
                } else {
                    snapshotCalc
                            .setClientTargetAge((int) MoneyCalc.UNKNOWN_VALUE);
                ...
                if (MaritalCode.isSingle(personName.getMaritalCodeID())) {
                    ...
                    if (fg != null) {
                        Integer n = fg.getTargetAge();
                        snapshotCalc
                                .setPartnerTargetAge(n == null ? (int) MoneyCalc.UNKNOWN_VALUE
                                        : n.intValue());
                        ...
                        snapshotCalc
                                .setPartnerTargetAge((int) MoneyCalc.UNKNOWN_VALUE);
                    }
